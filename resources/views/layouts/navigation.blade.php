        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Organisation::class)
                        <x-dropdown-link href="{{ route('organisations.index') }}">
                        Organisations
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\MeetingRoom::class)
                        <x-dropdown-link href="{{ route('meeting-rooms.index') }}">
                        Meeting Rooms
                        </x-dropdown-link>
                        @endcan
                </x-nav-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\MeetingRoom::class)
                <x-responsive-nav-link href="{{ route('meeting-rooms.index') }}">
                Meeting Rooms
                </x-responsive-nav-link>
                @endcan
