<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.meeting_rooms.index_title')
        </h2>
    </x-slot>
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $meetingRoom)
                                        <a
                                            href="{{ route('meeting-rooms.edit', $meetingRoom) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $meetingRoom)
                                        <a
                                            href="{{ route('meeting-rooms.show', $meetingRoom) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $meetingRoom)
                                        <form
                                            action="{{ route('meeting-rooms.destroy', $meetingRoom) }}"
                                            method="POST"
